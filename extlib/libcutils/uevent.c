...
int uevent_open_socket(int buf_sz, bool passcred)
{
	...
	/* netlink在用户态使用标准的socket与内核通信
	 * 1.创建套接字
	 * netlink对应的协议簇是AF_NETLINK/PF_NETLINK
	...
	/*
	 * SO_PASSCRED - 启用或禁用接收SCM_CREDENTIALS控制消息
	 */
    setsockopt(s, SOL_SOCKET, SO_RCVBUFFORCE, &buf_sz, sizeof(buf_sz));		/* 设置接收缓冲区的大小 */
